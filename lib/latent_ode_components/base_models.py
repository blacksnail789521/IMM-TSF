...
import lib.utils as utils_share
from lib.evaluation import *
import lib.latent_ode_components.utils_latent_ode as utils
...
class Baseline(nn.Module):
	...
	def compute_all_losses(self, batch_dict,
		...
		# print(batch_dict["tp_to_predict"].shape, batch_dict["observed_tp"].shape)
		# print(pred_x.shape)
...
class VAE_Baseline(nn.Module):
	...
	def evaluation(self, dataloader, n_batches, n_traj_samples = 1, kl_coef = 1.):
		...
		for _ in range(n_batches):
			batch_dict = utils_share.get_next_batch(dataloader)
